...
10. **Extension name/packaging** — "Chrome Agent Platform" is a placeholder. Rename + package for distribution later (low priority; decide before any public release).
11. **The model for the hub** — Gemini Nano is weak for tool-calling; which provider should be the recommended default for the best experience?
