# date_formatter_bounded notices and component inventory

## CAP clean-room source

- Component: `date_formatter_bounded` (`source/main.c`)
...
- Role: statically linked C runtime, `clock_time_get`, and WASI preview-1 bindings
