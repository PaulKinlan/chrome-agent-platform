...
// j6au's static Options rehydration imports tree-shake admission validation.
// Only SW has an origin site; Options must remain Wasm-free, not optional.
const EXPECTED = ["background/service-worker.js"];
const GENERATED = [...EXPECTED, "options.bundle.js", "workers/agent-worker.js", "shared/diff-core.bundle.js"].sort();
