...
> Archived completed/merged tasks moved out of `TASKS.md` on 2026-08-25. Active work lives in `TASKS.md`. New DONE/MERGED entries should be moved here at triage/audit time.
