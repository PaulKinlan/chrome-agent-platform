...
## [0.2.610] — 2026-09-01
- Housekeeping: the previous release note is reworded in plain language.

## [0.2.609] — 2026-09-01
- Security: an agent name containing quotes and angle brackets now renders as plain text on both the hub and Settings (verified in a real browser), and internal identifiers keep the exact shapes the extension validates.
...
## [0.2.603] — 2026-09-01
- Security: one HTML escaper across the extension — the hub, Settings, the memory explorer and the local assistant now share the strict escaper (single quotes included) instead of carrying their own weaker copies, and a test fails if a second copy ever appears.
