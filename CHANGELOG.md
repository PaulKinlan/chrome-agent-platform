...
## [0.3.476] — 2026-09-24
- the check gate reads the composer through the resolver, so a live feature stops reporting as a product red
...
## [0.3.472] — 2026-09-23
- the new-tab sidebar rows now display badge icons alongside agent names, matching the side panel
