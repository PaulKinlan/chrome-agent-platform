...
export const RETAINED = {
  ...
  "chat/chat.html":
    "CAP-FB-20260830-ONE-SHELL-01 decides the chat surface (chat.js and shared/composer.css go with it).",
  "chat/chat.js":
    "CAP-FB-20260830-ONE-SHELL-01 decides the chat surface.",
  "memory/explorer.html":
    "CAP-FB-20260830-ONE-SHELL-01 decides the memory explorer.",
  "memory/explorer.js":
    "CAP-FB-20260830-ONE-SHELL-01 decides the memory explorer.",
