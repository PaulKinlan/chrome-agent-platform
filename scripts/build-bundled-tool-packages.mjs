...
import { emitFrozenData } from "./lib/emit-frozen-data.mjs";
...
emit(join(REPO, "extension/lib/bundled-inventory-data.js"), banner + emitFrozenData("BUNDLED_INVENTORY", inventory));
emit(join(REPO, "extension/lib/bundled-tool-packages.data.js"), banner + emitFrozenData("BUNDLED_TOOL_PACKAGE_ROWS", descriptorRows));
