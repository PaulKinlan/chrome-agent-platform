...
`);
writeFileSync(join(REPO, "packages/bundled/README.md"), `# Bundled tool packages (immutable; 23-tool Settings-preview tranche)
...
(inventory sha256 d58fb443754689f7cf8a7cef55077c522b9401bf8b75f4250a5a589de55b7aa8).
