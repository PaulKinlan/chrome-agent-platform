...
{ // jxl (CAP-authored WASI driver over the jxl-oxide crate; pure Rust; agpu option B): MIT OR Apache-2.0
  const wasm = readFileSync(join(PATHS.jxl, "build-a/jxl.wasm"));
  if (sha256(wasm) !== "d268e1ced9db8192d986d2138b03dcec174a88865e10e9f9c7c8e53ab3c0010a" || wasm.byteLength !== 1376194) throw new Error("jxl hash/size mismatch");
