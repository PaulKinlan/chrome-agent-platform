...
const SETTINGS_PREVIEW_LANES = new Set(["csvtool", "uuid", "head", "tail", "cut"]);
...
`);
writeFileSync(join(REPO, "packages/bundled/README.md"), `# Bundled tool packages (immutable; 5-tool Settings-preview tranche)
...
(inventory sha256 7452f09dc4eabb067c3730772e3dd2ae25d10554ad902cd9ea4e6a1163c54126).
...
- Descriptors (\`extension/lib/bundled-tool-packages.data.js\`): ONLY the static
  tranche \`csvtool\`, \`uuid\`, \`head\`, \`tail\`, \`cut\` are
  ...
  authority). The other 20 remain \`admitted:false\`, \`disabled:true\` (reason
