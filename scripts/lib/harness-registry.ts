...
export const HARNESSES: Record<string, HarnessEntry> = {
  ...
  "ui-integration.ts": { class: "named", npm: "test:ui", reason: "green after the 5ht repair (hub moved #run-log → action-ledger; theme switching removed; durability contract now state-conditional; 6-min watchdog caps any hang); ~60s; run on demand — promotion is the owner's call" },
