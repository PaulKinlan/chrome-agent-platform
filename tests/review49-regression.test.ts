...
// Frozen module witnesses vendored in-repo (see ../tests/fixtures/artifact-tx-4eaf0d34/README.md)
// so this suite never depends on a worktree path outside the repo.
