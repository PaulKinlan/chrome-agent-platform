...
// Import the repo's OWN modules (bead chp / lhzk: this used to import a
// hardcoded /tmp snapshot copy of main, which broke on any tmpfs wipe and
// silently tested stale bytes). import.meta.url-relative paths track the
// worktree the test runs in.
