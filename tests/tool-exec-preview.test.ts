...
Deno.test("preview: immutable revalidation passes on the REAL shipped bytes for ALL 33 allowlisted tools", async () => {
...
Deno.test("preview: the EXACT 33-tool static allowlist admits every shipped package", async () => {
  ...
  assertEquals(notAdmitted.length, 0, "all 33 are enabled");
