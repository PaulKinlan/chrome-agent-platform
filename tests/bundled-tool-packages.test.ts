...
Deno.test("posture: descriptors admitted EXACTLY for the 22-tool settings-preview allowlist", () => {
  ...
  // ALL 22 admitted rows retain truthful per-tool caveats. Markdown has an
