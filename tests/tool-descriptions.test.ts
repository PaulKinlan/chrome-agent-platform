...
Deno.test("tool naming & descriptions: all 38 tools have Unix-name displayName and lead with '<toolname> - '", () => {
  assertEquals(BUNDLED_TOOL_PACKAGE_ROWS.length, 38, "exact 38 bundled tool rows");
  assertEquals(Object.keys(AGENT_DESCRIPTIONS).length, 38, "exact 38 agent descriptions");
