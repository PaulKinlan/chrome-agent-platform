...
Deno.test("master-skill: operating manual truthfully includes list_tools and the 32 bundled Wasm tools", () => {
  ...
  assert(MASTER_SKILL.includes("32 on-device bundled Wasm tools"), "MASTER_SKILL must mention 32 bundled Wasm tools");
