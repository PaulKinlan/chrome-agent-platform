...
Deno.test("znx9: over-cap messages stored COMPLETE (owner no-limits directive)", async () => {
  ...
  assertEquals(bytes, overCap.length, "content is stored COMPLETE — no truncation");
});
