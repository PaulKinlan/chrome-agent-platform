...
/** Import a fresh system-prompts module instance so attestation-key cache
 * lifecycle tests never require a reset export in shipped production code. */
export function freshSystemPrompts() {
  return import(`../extension/lib/system-prompts.js?fresh=${bust()}`);
}
