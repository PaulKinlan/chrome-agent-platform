...
// (CAP-FB-20260831-SKILL-PROMOTION-01).
//
// An agent with NO attached skills is told which catalog skills are relevant
// to the CURRENT task: a bounded, deterministic relevance heuristic selects
// the top-N by keyword overlap between the task text and each skill's
