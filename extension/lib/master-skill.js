...
- 38 on-device bundled Wasm tools (list_tools("bundled-wasm")): grep, awk,
sort, base64, jq, csvtool, toml2json,
sqlite3_query_bounded, xxd, uuid, gzip, imageops, compressops, oxipng, avif… They are NOT in your default
tool list.
