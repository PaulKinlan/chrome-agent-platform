...
const handlers = mergeRouteMaps(
  ...
  // The Directory's per-site enrollment-policy reads (CAP-FB-20260819-
  // DIRECTORY-TOOL-EXPLORER-01): the live policy for every enrolled origin
  // (owner surface only — never in PAGE_ALLOWED_ROUTES).
