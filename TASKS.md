...
- Blockers: —
- Next: the executor — map the five ops onto the existing MAIN-world bridge, under the same grant/approval authority as any other site tool. Then storage (adapters in the site registry), then the ambient availability path, then the registry-as-history UI
