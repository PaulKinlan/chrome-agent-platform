...
> completed entries live in `TASKS-DONE.md`. Active counts: **119 nonterminal**; every 2026-08-30 entry is written in the detailed hand-off format (owner directive 2026-08-30).
...
|---|---|---|
| `CAP-FB-20260830-BROWSER-LEASE-DEADLOCK-01` | `cap/lease-deadlock` | 2026-08-30 16:30 UTC |
...
- Blockers: —
- Next: decide keep-vs-remove for `extension/lib/browser-command-lease.js` and record it in History; the recommended default is REMOVE (two deadlocks, no observed benefit — the grant mutex already serialises check-and-mutate). If kept, split authority from mutation as in Steps 2-6.
