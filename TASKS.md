...
> completed entries live in `TASKS-DONE.md`. Active counts: **66 nonterminal**; every 2026-08-30 entry is written in the detailed hand-off format (owner directive 2026-08-30).
...
| `CAP-FB-20260830-DEAD-CODE-CUT-01` | `cap/dead-code-cut` | 2026-09-02 02:20 UTC |
| `CAP-FB-20260830-USER-VOICE-COPY-01` | `cap/user-voice-copy` | 2026-09-02 02:20 UTC |
| `CAP-FB-20260902-ORIGIN-GRANT-UNION-01` | `cap/origin-grant-union` | 2026-09-02 02:20 UTC |
...
| P1 | OPEN | [`CAP-FB-20260902-ORIGIN-GRANT-UNION-01`](#cap-fb-20260902-origin-grant-union-01-a-second-sites-allow-replaces-the-first-sites-browser-control-grant-so-the-first-site-denies-again) | A second site's Allow replaces the first site's browser-control grant, so the first site denies again |
...
- Owner: model worker (Fable 5 subagent) under the reanalysis coordinator session — CLAIMED; do not start a parallel attempt
- Workspace: active (local path private)
- Branch: `cap/dead-code-cut` (pushed to origin as the candidate branch; merged by the coordinator)
- Base: `f54d8661`
- Candidate: —
- Shipping: —
...
- History:
  ...
  - 2026-09-02 02:20 UTC — CLAIMED by the reanalysis coordinator; worker started in its own worktree on `cap/dead-code-cut` off `origin/main@f54d8661`. Other agents: pick a different entry.
...
- Owner: model worker (Fable 5 subagent) under the reanalysis coordinator session — CLAIMED; do not start a parallel attempt
- Workspace: active (local path private)
- Branch: `cap/user-voice-copy` (pushed to origin as the candidate branch; merged by the coordinator)
- Base: `f54d8661`
- Candidate: —
- Shipping: —
...
- History:
  ...
  - 2026-09-02 02:20 UTC — CLAIMED by the reanalysis coordinator; worker started in its own worktree on `cap/user-voice-copy` off `origin/main@f54d8661`. Other agents: pick a different entry.
...
- Owner: model worker (Fable 5 subagent) under the reanalysis coordinator session — CLAIMED; do not start a parallel attempt
- Workspace: active (local path private)
- Branch: `cap/origin-grant-union` (pushed to origin as the candidate branch; merged by the coordinator)
- Base: `f54d8661`
- Candidate: —
- Shipping: —
...
- History:
  ...
  - 2026-09-02 02:20 UTC — CLAIMED by the reanalysis coordinator; worker started in its own worktree on `cap/origin-grant-union` off `origin/main@f54d8661`. Other agents: pick a different entry.
