...
> completed entries live in `TASKS-DONE.md`. Active counts: **113 nonterminal**; every 2026-08-30 entry is written in the detailed hand-off format (owner directive 2026-08-30).
...
| `CAP-FB-20260830-PROVIDER-ERROR-TRUTH-01` | `cap/provider-error-truth` | 2026-08-30 14:24 UTC |
...
- Blockers: —
- Next: coordinator merge of `cap/provider-error-truth`
