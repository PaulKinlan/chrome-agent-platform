...
- History:
  ...
  - 2026-08-29 21:55 UTC — final suite 2363 pass / 0 fail and developer build green. Real loaded-extension CDP acceptance 9/9: seeded interactive agents, observed stopped schedules in the task sidebar, opened a stopped agent surface, deep-linked Settings to the unified list, enabled a stopped schedule and observed its marker change, then enabled provider tools and verified the Gemini/Anthropic billing copy plus per-agent search consequence. Screenshots: `.cache/agents-merge-evidence/01`–`05`.
