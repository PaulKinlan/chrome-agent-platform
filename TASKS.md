...
> completed entries live in `TASKS-DONE.md`. Active counts: **106 nonterminal**; every 2026-08-30 entry is written in the detailed hand-off format (owner directive 2026-08-30).
...
| `CAP-FB-20260830-KEYLESS-FIRST-RESULT-01` | `cap/keyless-first-result` | 2026-08-30 14:54 UTC |
...
- Blockers: —
- Next: coordinator merge (union with any lane touching `provider.js` / `demo-model.js` / `chrome-journeys.ts` EXPECTED); then DONE
