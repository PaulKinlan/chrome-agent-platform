...
- Review: independent review BLOCK round 3 on candidate `49a21e5d`; the remaining P1 normalization/accounting finding is addressed in revision 3, re-review pending.
...
- History:
  - 2026-08-29 09:00 UTC — revision 3 exposed provider-reported query occurrence count before the 32-text retention cap and made it the accumulator's billing input after round-3 review BLOCK.
