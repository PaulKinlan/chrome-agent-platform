...
- Blockers: —
- Next: capture the last provider HTTP error (already logged as `[provider] HTTP 401 ...` at `extension/lib/agent.js:636`) in the model wrapper and carry it through the stream failure
