...
> completed entries live in `TASKS-DONE.md`. Active counts: **110 nonterminal**; every 2026-08-30 entry is written in the detailed hand-off format (owner directive 2026-08-30).
...
| `CAP-FB-20260830-AGENT-TEMPLATES-INTEGRATION-01` | `cap/agent-templates-integration` | 2026-08-30 14:54 UTC |
...
| P0 | OPEN | [`CAP-FB-20260830-AGENT-TEMPLATES-INTEGRATION-01`](#cap-fb-20260830-agent-templates-integration-01-templates-are-the-first-class-way-to-create-an-agent-and-the-agent-lists-show-only-agents-the-user-created-or-enabled) | Templates are the first-class way to create an agent, and the agent lists show only agents the user created or enabled |
...
- Next: coordinator merge (union with main) → full gates → push → DONE.
