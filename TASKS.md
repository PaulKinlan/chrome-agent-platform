...
- Branch: none
- Base: `139b6f92`
- Candidate: `docs/THREAD-LOADING-REDESIGN.md` + `scripts/thread-open-trace.ts` — measurements and a design, awaiting owner review before any storage change
- Shipping: —
...
- Blockers: —
- Next: OWNER REVIEW of the design. Then stage 1 (concurrent reads, no storage change), which should take the 1,000-row case from ~960 ms to ~150-250 ms; if it does not, the model is wrong and stages 2-4 get re-argued before proceeding
