...
- Blockers: —
- Next: coordinator merge; a genuinely headed fresh-profile check (one card + one native prompt) still needs a machine with a display — see History.
