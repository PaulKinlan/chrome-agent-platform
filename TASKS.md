...
- Next: coordinator merges the guard + the two deletions; then a follow-up commit deletes the test-only RETAINED modules together with their tests, and the owner records the SharedWorker decision.
