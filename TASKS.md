...
## Active lanes (claimed — 2026-09-02 03:38 UTC)
...
|---|---|---|
| `CAP-FB-20260902-BUDGET-VERDICT-ANSWERED-01` | `cap/budget-verdict-answered` | 2026-09-02 03:38 UTC |
| `CAP-FB-20260830-ARTIFACT-QUICK-FIXES-01` | `cap/artifact-quick-fixes` | 2026-09-02 03:38 UTC |
| `CAP-FB-20260830-SETTINGS-HOOKS-PERMISSIONS-TABLES-01` | `cap/settings-hooks-permissions-tables` | 2026-09-02 03:38 UTC |
...
- Next: coordinator merge of `cap/settings-hooks-permissions-tables` (union with the sibling one-card-per-step lane if it touches `extension/lib/capabilities.js`; this lane only adds `group:` lines and `CAPABILITY_GROUPS`).
