...
- History:
  ...
  - 2026-09-02 08:09 UTC — DONE: merged forward by the coordinator and pushed as `origin/main@351f672c`. Fast-forward onto main. Coordinator gates on the merged tip: build clean, check:gallery + check:vocabulary clean, unit /0, journeys 345/345.
