...
> completed entries live in `TASKS-DONE.md`. Active counts: **57 nonterminal**; every 2026-08-30 entry is written in the detailed hand-off format (owner directive 2026-08-30).
...
- History:
  ...
  - 2026-09-02 09:13 UTC — DONE: merged forward by the coordinator and pushed as `origin/main@23fe89c9`. Coordinator gates on the merged tip: build clean, check:gallery + check:vocabulary (17 surfaces) clean, unit 3101/0, journeys 355/355. Two factory-reset defects fixed with it: the route called an undefined function so it reported failure after wiping, and IndexedDB stores survived every reset while the report said clean.
