...
> completed entries live in `TASKS-DONE.md`. Active counts: **117 nonterminal**; every 2026-08-30 entry is written in the detailed hand-off format (owner directive 2026-08-30).
...
- Blockers: —
- Next: coordinator merge of `cap/fresh-profile-template-agents`.
