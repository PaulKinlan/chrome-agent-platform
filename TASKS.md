...
- Blockers: Depends on CAP-FB-20260830-FRESH-PROFILE-TEMPLATE-AGENTS-01 (must land first)
- Next: step 2 — extend `agent-template-card` (selected/blank/skillNames/whole-card activation) with its gallery specimen, so the dialog work in step 4 is a pure composition.
