...
> completed entries live in `TASKS-DONE.md`. Active counts: **116 nonterminal**; every 2026-08-30 entry is written in the detailed hand-off format (owner directive 2026-08-30).
...
<<<<<<< HEAD
| `CAP-FB-20260830-MODEL-CATALOG-CURRENT-01` | `cap/model-catalog-current` | 2026-08-30 16:30 UTC |
=======
...
| P1 | OPEN | [`CAP-FB-20260830-MODEL-CATALOG-CURRENT-01`](#cap-fb-20260830-model-catalog-current-01-every-model-id-the-extension-ships-suggests-or-tests-against-is-a-current-callable-id) | Every model id the extension ships, suggests or tests against is a current, callable id |
...
- Blockers: —
- Next: land the cut (remove run_script and create_script from the interactive toolset) in one commit, the gate in the next
...
- Blockers: —
- Next: coordinator merge (rebase onto the `origin/main` tip; union-resolve `TASKS.md`), then archive to `TASKS-DONE.md`.
